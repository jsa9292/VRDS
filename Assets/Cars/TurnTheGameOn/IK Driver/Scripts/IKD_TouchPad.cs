...
namespace TurnTheGameOn.IKDriver {
	public class IKD_TouchPad : MonoBehaviour {

		[RequireComponent(typeof(Image))]
		public class RG_TouchPad : MonoBehaviour, IPointerDownHandler, IPointerUpHandler{
			...
			void OnDisable(){
				if (IKD_CrossPlatformInputManager.AxisExists(horizontalAxisName))
					IKD_CrossPlatformInputManager.UnRegisterVirtualAxis(horizontalAxisName);

				if (IKD_CrossPlatformInputManager.AxisExists(verticalAxisName))
					IKD_CrossPlatformInputManager.UnRegisterVirtualAxis(verticalAxisName);
			}
		}
